...
var tutorial_hints = () => [
    ...
    <p>
        ...
        the <b>arrow keys</b> or <b>controller D-pad/left analog stick</b>, 
        and interact with objects using the <b>spacebar</b> or <b>B button</b>.
      </p>
      <p>
        You can interact with objects by facing them and pressing
        <b>spacebar</b> (or <b>B button</b> on controller). Here are some examples:
        <ul>
          <li>You can pick up ingredients (onions or tomatoes) by facing
            the ingredient area and pressing <b>spacebar/B button</b>.</li>
          <li>If you are holding an ingredient, are facing an empty counter,
            and press <b>spacebar/B button</b>, you put the ingredient on the counter.</li>
          <li>If you are holding an ingredient, are facing a pot that is not full,
            and press <b>spacebar/B button</b>, you will put the ingredient in the pot.</li>
          <li>If you are facing a pot that is non-empty, are currently holding nothing, and 
            and press <b>spacebar/B button</b>, you will begin cooking a soup.</li>
        </ul>
      </p>
    `,
    `
